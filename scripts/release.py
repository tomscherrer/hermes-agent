...
AUTHOR_MAP = {
    "aaron@meese.dev": "ajmeese7",  # PR #3219 salvage (whatsapp bridge: resolve LID sender IDs to phone numbers in the message payload so phone-based allowlists match; commit authored by collaborator r0gersm1th, PR by ajmeese7)
